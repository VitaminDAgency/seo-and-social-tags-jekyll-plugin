...
module Jekyll
  class SiteTag < Liquid::Tag
    ...
    def payload
      layout_name = context.registers[:page]["layout"]
      {
        "page"      => context.registers[:page],
        "layout"    => context.registers[:site].layouts[layout_name].data,
...
Liquid::Template.register_tag("social_and_seo_tags", Jekyll::SiteTag)
